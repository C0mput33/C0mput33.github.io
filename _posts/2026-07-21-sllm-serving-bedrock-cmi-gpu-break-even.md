...
3. 품질: CMI 엔드포인트를 평가 리그에 넣고 직접 대결, 사전 정의한 허용폭, 사람 골든셋을 확인한다. 모델별 CI 겹침은 표시용 진단으로만 본다.
