...
Terms: `CMI`, `CMU`, `Converse`, `InvokeModel`, `관리형 API`, `손익분기`, `스팟`, `온디맨드`
...
Terms: `AWQ`, `GGUF`, `L40S`, `MTP`, `MoE`, `Ollama`, `Qwen3.6-35B-A3B`, `linear attention`, `llama.cpp`, `sLLM`, `vLLM`, `양자화`, `통합 메모리`, `활성 파라미터`
...
Terms: `DPO`, `LoRA`, `MLX`, `QLoRA`, `TRL`, `safetensors`, `transformers`
...
Terms: `A/B`, `Arena 점수`, `Match Rate`, `contest`, `jury`, `retire2`, `top-k`, `골든셋`, `능동 표집`, `반응성 β`, `부활전`, `오은퇴`, `양방향 swap`, `위치 편향`, `자기 선호`, `체크포인트`
